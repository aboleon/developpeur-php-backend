    ...
    <div>
        ...
        <div id="sidebar-menu" class="main_menu_side bg-white main_menu">
            <ul class="nav side-menu">
                ...
                <x-aboleon-framework::nav-header-link title="Accueil" icon="fas fa-chart-pie" :route="route('aboleon-framework.dashboard')"/>
                {{--
                ...
                --}}
                <x-aboleon-framework::nav-header-link title="Administrateurs" icon="fas fa-user-lock" :route="route('aboleon-framework.users.index', 'super-admin')"/>
                ...
                <x-aboleon-framework::nav-header-link title="Entreprise" icon="fas fa-vcard" :route="route('aboleon-framework.appowner.index')"/>
                @endif
                @role('dev')
                <li class="sh-dark-grey">
                    <x-aboleon-framework::nav-opening-header title="Dev" icon="fas fa-code" class="sh-dark-grey"/>
                    <ul class="nav child_menu">
                        <x-aboleon-framework::nav-link :route="route('aboleon-framework.roles', 'super-admin')" title="Rôles"/>
